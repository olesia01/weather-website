...
const APIKEY = 'b28516ca225da5c8cbde638dd73bf158'
...
async function getWeatherData(location) {
  const respons = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=${APIKEY}&units=metric`)
...
function getNewCard() {
  ...
  <div class="card__head">
    ...
    <div class="card__head-right card-param">
      <svg class="card-param__icon" fill="#000000" width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M15,16a3,3,0,1,1-3-3A3,3,0,0,1,15,16ZM16,5v5.262a7,7,0,1,1-8,0V5a4,4,0,0,1,8,0Zm-1.5,6.675a1,1,0,0,1-.5-.865V5a2,2,0,0,0-4,0v5.81a1,1,0,0,1-.5.865,5,5,0,1,0,5,0Z"/></svg>
